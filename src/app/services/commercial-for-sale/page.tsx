                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                            Comprehensive commercial real estate solutions for investors and businesses
                        </p>
                    </div>
            ...
            <section className="bg-[#0f0f0f] text-white py-16 px-6 sm:px-10 lg:px-24">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-semibold mb-4">Invest in Commercial Property</h2>
                        <p className="text-gray-300">Fill out the form below and our team will help you find the perfect commercial property for sale.</p>
                    </div>
